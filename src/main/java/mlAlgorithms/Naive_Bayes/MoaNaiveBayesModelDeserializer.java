...
public class MoaNaiveBayesModelDeserializer implements Deserializer<MoaNaiveBayesModel> {

    @Override
    public MoaNaiveBayesModel deserialize(String topic, byte[] data) {
        ...
        try (ByteArrayInputStream byteStream = new ByteArrayInputStream(data);
         ...
         //    String algorithmParameters = dataIn.readUTF();
            ...
            try (ObjectInputStream objectIn = new ObjectInputStream(dataIn)) {
                NaiveBayes classifier = (NaiveBayes) objectIn.readObject();
                ...
                MoaNaiveBayesModel model = new MoaNaiveBayesModel(algorithmId,algorithmType,hyperParams,instancesHeader);
