...
public class MoaSGDModelDeserializer implements Deserializer<MoaSGDModel> {

    @Override
    public MoaSGDModel deserialize(String topic, byte[] data) {
        ...
        try (ByteArrayInputStream byteStream = new ByteArrayInputStream(data);
          ...
          //  String algorithmParameters = dataIn.readUTF();
            ...
            try (ObjectInputStream objectIn = new ObjectInputStream(dataIn)) {
               // HoeffdingTree classifier = (HoeffdingTree) objectIn.readObject();
                SGD sgd = (SGD) objectIn.readObject();
                ...
                MoaSGDModel model = new MoaSGDModel(algorithmId,algorithmType,hyperParams,instancesHeader);
