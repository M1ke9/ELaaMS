...
public class MoaDecisionTreeModelDeserializer implements Deserializer<MoaDecisionTreeModel> {

    @Override
    public MoaDecisionTreeModel deserialize(String topic, byte[] data) {
        ...
        try (ByteArrayInputStream byteStream = new ByteArrayInputStream(data);
           ...
           // String algorithmParameters = dataIn.readUTF();
            ...
            try (ObjectInputStream objectIn = new ObjectInputStream(dataIn)) {
                ...
                MoaDecisionTreeModel model = new MoaDecisionTreeModel(algorithmId,algorithmType,hyperParams,instancesHeader);
