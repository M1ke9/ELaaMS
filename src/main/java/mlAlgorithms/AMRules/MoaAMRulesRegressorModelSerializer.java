...
public class MoaAMRulesRegressorModelSerializer  implements Serializer<MoaAMRulesRegressorModel> {

    @Override
    public byte[] serialize(String topic, MoaAMRulesRegressorModel data) {
        if (data == null)
            return null;
