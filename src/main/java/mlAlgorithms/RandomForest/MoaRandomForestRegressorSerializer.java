...
public class MoaRandomForestRegressorSerializer implements Serializer<MoaRandomForestRegressorModel> {

    @Override
    public byte[] serialize(String s, MoaRandomForestRegressorModel data) {
        if (data == null)
            return null;
        try (ByteArrayOutputStream byteStream = new ByteArrayOutputStream();
            ...
            try (ObjectOutputStream objectOut = new ObjectOutputStream(dataOut)) {
                objectOut.writeObject(data.getRegressor());
            ...
            throw new RuntimeException("Error serializing MoaAdaptiveRandomForestModel", e);
        }
    }
}
