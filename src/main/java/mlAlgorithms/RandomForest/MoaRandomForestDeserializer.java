...
public class MoaRandomForestDeserializer implements Deserializer<MoaRandomForestModel> {

    @Override
    public MoaRandomForestModel deserialize(String topic, byte[] data) {
        ...
        try (ByteArrayInputStream byteStream = new ByteArrayInputStream(data);
            ...
            try (ObjectInputStream objectIn = new ObjectInputStream(dataIn)) {
                AdaptiveRandomForest classifier = (AdaptiveRandomForest) objectIn.readObject();
                ...
                MoaRandomForestModel model = new MoaRandomForestModel(algorithmId,algorithmType,hyperParams,instancesHeader);
