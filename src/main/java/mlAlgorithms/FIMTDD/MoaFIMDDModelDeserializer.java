...
public class MoaFIMDDModelDeserializer implements Deserializer<MoaFIMTDDModel> {

    @Override
    public MoaFIMTDDModel deserialize(String topic, byte[] data) {
        ...
        try (ByteArrayInputStream byteStream = new ByteArrayInputStream(data);
          ...
          //  String algorithmParameters = dataIn.readUTF();
            ...
            try (ObjectInputStream objectIn = new ObjectInputStream(dataIn)) {
                FIMTDD fimtdd = (FIMTDD) objectIn.readObject();
                ...
                MoaFIMTDDModel model = new MoaFIMTDDModel(algorithmId,algorithmType,hyperParams,instancesHeader);
