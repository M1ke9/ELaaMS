...
public class MoaKNNModelDeserializer implements Deserializer<MoaKNNModel> {

    @Override
    public MoaKNNModel deserialize(String topic, byte[] data) {
        ...
        try (ByteArrayInputStream byteStream = new ByteArrayInputStream(data);
            ...
            try (ObjectInputStream objectIn = new ObjectInputStream(dataIn)) {
                kNN classifier = (kNN) objectIn.readObject();
                ...
                MoaKNNModel model = new MoaKNNModel(algorithmId,algorithmType,hyperParams,instancesHeader);
