...
public class PredictionProducer1 implements Runnable {
   ...
   // private final int partition; // ADDED

    public PredictionProducer1(String filePath) {
        ...
        // If you have a custom partitioner, set it here if needed.
